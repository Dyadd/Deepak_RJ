...
We can draw from a rich literature of human-computer interaction (HCI), applied automation in aviation and now emerging human-centered AI (HCAI) to think about medical AI. Many new problems we're running into now are older problems in disguise. In this article, we'll draw on premises from the [key implementation challenges](/Deepak_RJ/blog/what-medicine-needs-to-get-right-about-ai/#the-implementation-challenge).

<div class="callout">
<div class="callout-title">Key Context</div>
...
![Situation Awareness](/Deepak_RJ/situation-awareness.jpg)

*Source: [Jiang et al.](https://www.tandfonline.com/doi/full/10.1080/10447318.2022.2093863)*
...
![Distributed Situation Awareness](/Deepak_RJ/distributed-situation-awareness.jpg)
...
1. **Dynamic Knowledge Retrieval** — AI can instantly access and synthesize vast medical literature, with real-time updates as new evidence emerges and contextual retrieval based on specific patient scenarios.

2. **Knowledge Iteration** — AI systems can test hypotheses across large datasets, rapidly identify patterns and correlations, and continuously learn from clinical outcomes.

3. **Knowledge Testing** — Simulation of treatment approaches, validation of guidelines across diverse populations, and early identification of potential risks or limitations.

4. **Knowledge Refinement** — Integration of multiple knowledge sources, adaptation to local contexts and populations, and identification of gaps in current understanding.
...
<div class="callout callout-important">
<div class="callout-title">Benefits for Physician Autonomy</div>
...
- Allowing investigation of AI recommendations **because it fits into physician SA** *(AI SA supports physician SA)*
...
#### Situation Awareness for Uncertainty
...
This approach recognizes that managing clinical uncertainty isn't passive - physicians need to actively engage with the information, controlling how they view and interpret different uncertainty elements based on their expertise and the specific patient context.
...
As the system grows in complexity, choosing what to show to clinicians grows in importance.

Like how micro-calculations of flap adjustment don't need to be visible to the pilot, physicians need a balanced view, enough to maintain trust while preventing information overload. The operational complexity can remain manageable with a moderate perceived complexity, despite significant objective complexity.

<div class="callout callout-tip">
<div class="callout-title">Complexity Definitions</div>

- **Objective Complexity:** objectively what the system is doing - considering guidelines, statistics, scan results, notes, etc.
- **Perceived Complexity:** the complexity perceived by the clinician. When we distribute knowledge like trusting the pathologist to accurately read biopsy slides or the MRI machine to function properly, the perceived complexity is reduced to a simple pathology report or conversation with the radiologist.
- **Operational Complexity:** refers to the task's complexity - diagnosing appendicitis may require multiple interdependent decisions, similar presenting symptoms potentially leading to different diagnoses, and the need to constantly re-evaluate as new information arrives.
...
#### Situation Awareness for Complexity
...
The system should adapt its complexity presentation based on factors like case urgency, physician experience level, time of day (cognitive load may be higher during night shifts), case similarity to typical presentations, and level of diagnostic certainty.

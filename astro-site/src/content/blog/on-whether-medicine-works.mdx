---
title: "On whether medicine works"
description: "Modes of intervention in dynamic disease, why measurement is the bottleneck, and what ophthalmology proves about closing the gap."
author: "Deepak RJ"
date: "2026-05-07"
categories: ["Medicine", "Computational Psychiatry"]
image: "/disease-map.png"
---
...
![Disease complexity vs tractability map. Diseases are plotted by the complexity of their generative process against current tractability, color-coded by the dominant intervention modality.](/disease-map.png)
...
![Time from clinical or mechanistic recognition to effective treatment, plotted against complexity. Mechanism-driven discoveries cluster at 13–50 years; empirical psychiatric discoveries cluster at 50–60 years and plateau; diseases without effective treatment continue running past 70 years.](/time-to-solve.png)
